...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    href: "/tools",
    children: [
      { label: "전체 도구 보기",              href: "/tools" },
      { label: "사건 정보 정리",              href: "/tools/intake" },
      { label: "사건 유형 진단",              href: "/tools/triage" },
      { label: "문서 쉬운 말 풀이",           href: "/tools/document-translator" },
      { label: "보험금 가능성 셀프체크",       href: "/tools/coverage-check" },
      { label: "영문 계약서 1차 검토 (B2B)",   href: "/tools/contract-review" },
      { label: "구상 가능성 자가진단",         href: "/tools/subrogation-check" },
